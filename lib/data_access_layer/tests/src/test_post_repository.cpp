...
TEST(REPOSITORY_POST_TEST, GET_ADD_POST)
{
    ...
    PostBL adding_post = post_repo.add_post("name_1", 1, "info_1", "city_1",
                                            "organizer_1", "date_1");

    PostBL post("name_1", 1, "info_1", "city_1","organizer_1", "date_1");
...
TEST(REPOSITORY_POST_TEST, DELETE_POST)
{
    ...
    post_repo.add_post("name_1", 1, "info_1", "city_1", "organizer_1", "date_1");
    PostBL post("name_1", 1, "info_1", "city_1","organizer_1", "date_1");
...
TEST(REPOSITORY_POST_TEST, GET_POSTS)
{
    ...
    PostBL post_1("name_1", 1, "info_1","city_1","organizer_1", "date_1");
...
TEST(REPOSITORY_POST_TEST, UPDATE_POST)
{
    ...
    PostBL post("name_1", 1, "info_1","city_1","organizer_1", "date_1");
    PostBL upd_post("name_1", 1, "info_1_upd", "city_1", "organizer_1", "date_1_upd");
