...
TEST(CONTROLLER_ADMIN_TEST, SUBMIT_POST)
{
    ...
    PostBL post_3(name_3, 0, info_3, city_3, organizer_3, date_3);

    UserBL user_1("name_1", "surname_1", "login_1", "password_1", "city_1", "client", {});
    UserBL user_2("name_2", "surname_2", "login_2", "password_2", "city_2", "admin",{ post_3 });
...
{
    UserBL user_1("name_1", "surname_1", "login_1", "password_1", "city_1", "client", {});
    UserBL user_2("name_2", "surname_2", "login_2", "password_2", "city_2", "admin", {});
    std::vector<UserBL> users = { user_1, user_2 };
    UserRepository user_repo(users);
