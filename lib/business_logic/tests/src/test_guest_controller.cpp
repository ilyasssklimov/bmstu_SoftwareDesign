...
{
    PostBL post_1("name_1", 0, "info_1", "city_1", "organizer_1", "date_1");
    PostBL post_2("name_2", 1, "info_2", "city_2", "organizer_2", "date_2");
...
TEST(CONTROLLER_GUEST_TEST, GET_POSTS_BY_IDS)
{
    PostBL post_1("name_1", 0, "info_1", "city_1", "organizer_1", "date_1");
    PostBL post_2("name_2", 1, "info_2", "city_2", "organizer_2", "date_2");
    PostBL post_3("name_2", 2, "info_3", "city_3", "organizer_3", "date_3");
...
TEST(CONTROLLER_GUEST_TEST, LOG_IN)
{
    ...
    UserBL user_1("name_1", "surname_1", "login_1", "password_1", "city_1", "client", {});
    UserBL user_2("name_2", "surname_2", "login_2", "password_2", "city_2", "client", {});
    std::vector<UserBL> users = { user_1, user_2 };
    UserRepository user_repo(users);

    GuestController guest_controller(&post_repo, &user_repo);
    bool log_in_result = guest_controller.log_in("login_2", "password_2");

    EXPECT_TRUE(log_in_result);
}
